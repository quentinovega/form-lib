...
var ArrayResolver = /*#__PURE__*/function (_BaseResolver) {
  _inherits(ArrayResolver, _BaseResolver);

  var _super = _createSuper(ArrayResolver);

  function ArrayResolver(constraints) {
    var _this;

    _classCallCheck(this, ArrayResolver);

    _this = _super.call(this, 'array', constraints);
    ...
    _this.length = constraints.length;
    return _this;
  }

  _createClass(ArrayResolver, [{
    key: "toResolver",
    value: function toResolver(subResolver, key, dependencies) {
      var resolver = yup.array();
      ...
      return _get(_getPrototypeOf(ArrayResolver.prototype), "toBaseResolver", this).call(this, resolver, key, dependencies);
    }
  }]);
