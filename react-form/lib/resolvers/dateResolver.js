...
var DateResolver = /*#__PURE__*/function (_BaseResolver) {
  _inherits(DateResolver, _BaseResolver);

  var _super = _createSuper(DateResolver);

  function DateResolver(constraints) {
    var _this;

    _classCallCheck(this, DateResolver);

    _this = _super.call(this, 'date', constraints);
  ...
  _createClass(DateResolver, [{
    key: "toResolver",
    value: function toResolver(key, dependencies) {
      var resolver = yup.date();
      ...
      return _get(_getPrototypeOf(DateResolver.prototype), "toBaseResolver", this).call(this, resolver, key, dependencies);
    }
  }]);
