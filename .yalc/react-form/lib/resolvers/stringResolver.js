...
var StringResolver = /*#__PURE__*/function (_BaseResolver) {
  _inherits(StringResolver, _BaseResolver);

  var _super = _createSuper(StringResolver);

  function StringResolver(constraints) {
    var _this;

    _classCallCheck(this, StringResolver);

    _this = _super.call(this, 'string', constraints);
    ...
    _defineProperty(_assertThisInitialized(_this), "matches", void 0);

    _this.min = constraints.min;
    _this.max = constraints.max;
    _this.email = constraints.email;
    _this.url = constraints.url;
    _this.uuid = constraints.uuid;
    _this.matches = constraints.matches;
    return _this;
  }
  ...
  _createClass(StringResolver, [{
    ...
    value: function toResolver(key, dependencies) {
      ...
      if (this.matches) {
        resolver = resolver.matches(this.matches.regexp, {
          message: this.matches.message
        });
      }

      return _get(_getPrototypeOf(StringResolver.prototype), "toBaseResolver", this).call(this, resolver, key, dependencies);
    }
  }]);
